      ...
      <section className="welcomePage__section">
        ...
        >
          ...
          <div className="bloc__pDiv">
            ...
            <Link className="bloc__p__link" to="/workers"><span className="bloc__arrow">&#8594;</span>  Lire la suite de l'article</Link>
          </div>
        </article>
        ...
        <article className="bloc__article bloc__article--mobile"
          ...
          <div className="bloc__pDiv">
            ...
            <Link className="bloc__p__link" to="/sheabenefits"><span className="bloc__arrow">&#8594;</span> Lire la suite de l'article</Link>
          </div>
          <div className="bloc__imgDiv">
